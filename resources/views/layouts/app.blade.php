                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('consultau') }}"><i class="fa fa-fw fa-user-circle"></i>Usuarios <span class="badge badge-success"></span>
                                </a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('consultac') }}"><i class="fa fa-fw fa-rocket"></i>Clientes</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('consultae') }}" ><i class="fas fa-fw fa-chart-pie"></i>Empleados</a>

                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('consultap') }}"><i class="fab fa-fw fa-wpforms"></i>Productos</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('consultav') }}" ><i class="fas fa-fw fa-table"></i>Ventas</a>
