                ...
                <div class="row">
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{route('modificau', $consulta->id)}}" method="GET">
                                                {{ csrf_field() }}
                                                      {{ method_field('PUT') }}
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" placeholder="Ingresa el Nombre de Usuario"  name="usuario" class="form-control" value="{{$consulta->usuario}}" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="password" required="" name="password" placeholder="Ingresa tu Contraseña" class="form-control" value="{{$consulta->password}}">
                                            </div>
                                        </div>
                                    ...
                                    <a href="{{ route('consultau') }}"><button class="btn btn-space btn-secondary">Cancelar</button></a>
                                </div>
                            </div>
                        </div>
                </div>
